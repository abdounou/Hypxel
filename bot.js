 ...
 **
رابط البوت | https://discordapp.com/api/oauth2/authorize?client_id=527881514944299048&permissions=0&scope=bot
 **
`);
  message.author.sendEmbed(embed);
   }
 ...
 **
رابط السيرفر | https://discord.gg/XA9Bnpt
 **
`);
  message.author.sendEmbed(embed);
   }
...
client.on('message', msg => {
  if (msg.content === '.') {
    msg.channel.send(' **__-Wèlçomè Ťø Hypxel Śeŕveŕ__** ');
  }
});
